...
//     els = e.parentElement.parentElement.childNodes
...
//             user_reacts_array = global.user_reacts_arrays[i].split(' ');
//         }
//     }
...
//             user_reacts_array = global.user_reacts_arrays[i];
...
//             if (global.username != usersUsernameList[numRow]) {
...
//         if (!global.username || !isUserLoggedIn) { // if the prayer room has already been saved by the user, don't show the option to save it
...
//             if (global.username == usernameList[i]) {
//                 count++;
...
//                                 if (global.username == usernameList[roomCounter]) {
...
//         // for the user's own rooms add a button for them to change that room's settings
//         if (global.username == testimonialsUsernameList[roomCounterTemp]) {
...
//             // console.log("username: " + global.username + " | usernameList[i]: " + usernameList[i]);
//             if (global.username == pearlsUsernameList[i]) {
//                 count++;
//                 // console.log("count: " + count);
//                 if (count == numRowWithEditButton) {
//                     numRow = i;
...
//         // for the user's own rooms add a button for them to change that room's settings
//         if (global.username == pearlsUsernameList[roomCounterTemp]) {
