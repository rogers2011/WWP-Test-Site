const { default: DefaultTagsContainer } = require("./DefaultTagsContainer");
const { default: SortEntriesMenu } = require("./SortEntriesMenu");
                ...
                <div className="create_intention_container_2">
                    <div className="create_intention_container_1">
                        ...
                        <div className="intention_title_input_container">
                            <input type="text" id="intention_title_input" name="intention_title_input" placeholder="Intention Title" autoComplete="off" maxLength="100" />
                            <br />
                        </div>
