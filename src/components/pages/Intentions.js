...
// import {closeMenusWindow} from "../../js/global-functions.js"
...
function Home() {
  ...
  <div id="intentionsSideNav" className="sidenav menu-list-item-map" style="z-index: 100;">
        ...
        <div id="create_intention_container" className="create_intention_container_3">
            ...
            <div className="create_intention_container_2">
                <div className="create_intention_container_1">
                    ...
                    <textarea id="intentions_text_area" name="intentionsTextArea" placeHolder="Intention Description" style="justify-content: center; text-align: left;" wrap="hard" maxLength="5000000"></textarea>
                </div>
            </div>
